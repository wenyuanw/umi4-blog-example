    ...
    case "POST":
      try {
        ...
        const user = await prisma.user.create({
          data: {
            email: "wwenyuan@163.com",
            passwordHash: import_bcryptjs.default.hashSync("12345678", 8),
            name: "\u6587\u5458",
            avatarUrl: "https://p9-passport.byteacctimg.com/img/user-avatar/b661fc2588e3187e0357844ca82178a1~300x300.image"
          }
        });
